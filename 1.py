...
# 取得音訊特徵的 API 端點，注意 {track_id} 是一個佔位符
FEATURES_API_URL = "https://api.spotify.com/v1/audio-features/{track_id}"
...
def get_audio_features(track_id, access_token):
    ...
    features_url = FEATURES_API_URL.format(track_id=track_id)
